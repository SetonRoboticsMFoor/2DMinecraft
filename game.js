...
function updateCrafting() { document.querySelectorAll('.recipe').forEach(button => { const item = button.dataset.recipe; button.disabled = item === 'pickaxe' || item === 'axe' || item === 'shovel' ? inventory.planks < 1 || inventory.sticks < 1 : inventory.wood < 5; }); }
